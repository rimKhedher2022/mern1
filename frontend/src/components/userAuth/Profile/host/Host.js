...
//
import HostMyExperiences from "./hostMyExperiences/HostMyExperiences";
import muiButtonSx from "./MuiStyles";
import HostFavourites from "./hostFavourites/HostFavourites";
import HostRequests from "./hostRequests/HostRequests";
...
const Host= () =>{
    ...
    //Array of tabs label
    const tabsLabels= ['My experiences', 'Favourites', 'Requests', 'Profile', 'Messages']
    ...
    return(
        ...
        <Box className="m-12">
            ...
            <Box className="mt-16 ml-[130px]">
                <TabPanel value={activeTab} index={0}> <HostMyExperiences/> </TabPanel>
                <TabPanel value={activeTab} index={1}> <HostFavourites/> </TabPanel>
                <TabPanel value={activeTab} index={2}> <HostRequests/> </TabPanel>
                <TabPanel value={activeTab} index={3}> <HostProfile/> </TabPanel>
