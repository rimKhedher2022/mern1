...
const GeneralInformation = ({ generalFormValues, changeGeneralValue }) => {
  ...
  const onSelect = (e,options) => {
	changeGeneralValue('country', options.label)
	generalFormValues.country=options.label
	changeGeneralValue('e', options)
  ...
  return (
    ...
    />
        ...
        <Select				
		  ...
		  value={generalFormValues.city}
        onChange={(e) => changeGeneralValue('city', e.target.value)} 
        >
          {states.map((name) => (
            <MenuItem
              key={name}
		...
		name="email"
		value={generalFormValues.address}
        onChange={(e) => changeGeneralValue('address', e.target.value)} 
        sx={{
          background:color,
          svg: { colors },
          input: { colors },
        ...
        id="input-with-icon-textfield"
		name="codepostale"
		value={generalFormValues.codepostale}
        onChange={(e) => changeGeneralValue('codepostale', e.target.value)} 
        sx={{
          background:color,
          svg: { colors },
          input: { colors },
        ...
        id="input-with-icon-textfield"
		name="homme"
		value={generalFormValues.homme}
        onChange={(e) => changeGeneralValue('homme', e.target.value)} 
        sx={{
          background:color,
          svg: { colors },
          input: { colors },
        ...
        id="input-with-icon-textfield"
		name="femme"
		value={generalFormValues.femme}
        onChange={(e) => changeGeneralValue('femme', e.target.value)} 
        sx={{
          background:color,
          svg: { colors },
          input: { colors },
