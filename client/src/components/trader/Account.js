...
const onChangee = e => {
  ...
  return (
	...
	<div className='form-group'   style={{display:"flex", alignItems:"center", justifyContent:"center"}}>  
        ...
        id="input-with-icon-textfield"
				name="contactpersone"
        value={informationFormValues.contactpersone}
        onChange={(e) => changeInformationValue('contactpersone', e.target.value)} 
        sx={{
          background:color,
          svg: { colors },
          input: { colors },
        ...
        value={informationFormValues.confirmpassword}
        onChange={(e) => changeInformationValue('confirmpassword', e.target.value)} 
        sx={{
          background:color,
          svg: { colors },
          input: { colors },
