...
const Account2 = ({ account2FormValues, changeAccount2Value }) => {
    ...
    const onChangee = e => {
      ...
      reader.onload = () => {
        if (reader.readyState === 2) {
            changeAccount2Value('avatarPreview', reader.result);
        }	
  ...
  const onSelect = (e,options) => {
    changeAccount2Value('country', options.label)
    account2FormValues.country=options.label
    changeAccount2Value('e', options)
  ...
  return (
	...
	<div className='form-group' style={{display:"flex", alignItems:"center", justifyContent:"center"}} >  
        ...
        <Grid item xs={12} md={4}>
         <Typography  style={{ color:"black", textAlign: "left" }}>Company Name :</Typography> 
          <TextField
        id="input-with-icon-textfield"
				name="fullname"
        value={account2FormValues.name}
        onChange={(e) => changeAccount2Value('name', e.target.value)} 
        sx={{
          background:color,
          svg: { colors },
          input: { colors },
        ...
        <Grid item xs={12} md={4}>
        <Typography  style={{ color:"black", textAlign: "left", }}>Contact Persone :</Typography> 
          <TextField
        id="input-with-icon-textfield"
				name="contactpersone"
        value={account2FormValues.contactpersone}
        onChange={(e) => changeAccount2Value('contactpersone', e.target.value)} 
        sx={{
          background:color,
          svg: { colors },
          input: { colors },
        ...
        id="input-with-icon-textfield"
				name="email"
        value={account2FormValues.email}
        onChange={(e) => changeAccount2Value('email', e.target.value)} 
        sx={{
          background:color,
          svg: { colors },
          input: { colors },
        ...
        id="input-with-icon-textfield"
				name="phone"
        value={account2FormValues.phone}
        onChange={(e) => changeAccount2Value('phone', e.target.value)} 
        sx={{
          background:color,
          svg: { colors },
          input: { colors },
        ...
        id="input-with-icon-textfield"
				name="password"
        value={account2FormValues.password}
        onChange={(e) => changeAccount2Value('password', e.target.value)} 
        sx={{
          background:color,
          svg: { colors },
          input: { colors },
        ...
        value={account2FormValues.confirmpwd}
        onChange={(e) => changeAccount2Value('confirmpwd', e.target.value)} 
        sx={{
          background:color,
          svg: { colors },
          input: { colors },
    ...
    />
        ...
        <Select				
		  ...
		  value={account2FormValues.city}
		  onChange={(e) => changeAccount2Value('city', e.target.value)} 
          input={<OutlinedInput  />}
          MenuProps={MenuProps}
        ...
        id="input-with-icon-textfield"
		name="address"
		value={account2FormValues.address}
        onChange={(e) => changeAccount2Value('address', e.target.value)} 
        sx={{
          background:color,
          svg: { colors },
          input: { colors },
