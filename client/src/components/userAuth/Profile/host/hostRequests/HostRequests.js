...
//Other Imports
import HostExperiencePendingItem from "../hostMyExperiences/HostExperiencePendingItem";
import HostNewRequestItem from "./HostNewRequestItem";
import HostAcceptedRequestItem from "./HostAcceptedRequestItem";
import HostDeclinedRequestItem from "./HostDeclinedRequestItem";
                ...
                <Box className="mt-[50px] space-y-5">
                    {
                        acceptedRequests.length?
                            acceptedRequests.map(item=>(
                                <Box key={item.id}>
                                    <HostAcceptedRequestItem data={item}/>
                                </Box>
                            )):
                            //If new requests is empty show this
                            <Box className="arrayEmptyBox blueGradientText">
                ...
                <Box className="mt-[50px] space-y-5">
                    {
                        declinedRequests.length?
                            declinedRequests.map(item=>(
                                <Box key={item.id}>
                                    <HostDeclinedRequestItem data={item}/>
                                </Box>
                            )):
                            //If new requests is empty show this
                            <Box className="arrayEmptyBox blueGradientText">
