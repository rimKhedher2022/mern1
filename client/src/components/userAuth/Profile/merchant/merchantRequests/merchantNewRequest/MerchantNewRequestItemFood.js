...
const MerchantNewRequestItemFood = ({data}) =>{
            ...
            <Box className="itemsBoxRoundedRightBox bg-[#EEEEEE] space-y-4 pl-[11px] pt-6">
                ...
                <Box className="flex text-left mb-8 pl-[14px]">
                    ...
                    <Box className="importantItemTextFont ml-5 mt-4">
                        ...
                        <Box>
                            <a className="detailsTextFont" href="src/components/merchant/merchantRequests/merchantNewRequest/MerchantNewRequestItemFood#" target="_blank" style={{textDecorationLine: 'none'}}>Profile</a>
                        </Box>
                    </Box>
                </Box>
...
export default MerchantNewRequestItemFood;