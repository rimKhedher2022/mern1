...
const MerchantNewRequestItemLoding = ({data}) =>{
        ...
        <Box className="itemsBoxRounded flex">
            ...
            <Box className="space-y-5 itemsBoxRoundedLeftBox">
                ...
                <Box className="flex relative importantItemTextFont">
                    <Box>{data.reservation.service.price} DT/Night</Box>
                    <Box className="absolute right-0">  {data.reservation.service.location} </Box>
                </Box>
                {/* Location & details button */}
                <Box className="flex relative">
                    <Box className="importantItemTextFont"> <a>  {data.reservation.service.url} </a></Box>
            ...
            <Box className="itemsBoxRoundedRightBox bg-[#EEEEEE] space-y-4 pl-[11px] pt-6">
                ...
                <Box className="flex text-left mb-8 pl-[14px]">
                    ...
                    <Box className="importantItemTextFont ml-5 mt-4">
                        ...
                        <Box>
                            <a className="detailsTextFont" href="src/components/merchant/merchantRequests/merchantNewRequest/MerchantNewRequestItemLodging#" target="_blank" style={{textDecorationLine: 'none'}}>Profile</a>
                        </Box>
                    </Box>
                </Box>
...
export default MerchantNewRequestItemLoding;